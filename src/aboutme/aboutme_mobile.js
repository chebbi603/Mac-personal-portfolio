        ...
        <div className="aboutme-container">
            <div className="aboutme-textcontainer-mobile">
                ...
                <div className="aboutme-sec1-mobile">
                    ...
                    <p className="aboutme-sub">when a four year old kid was trying to explore computers and their capabilities and believed in the power of technology...</p>
                </div>
                <div className="aboutme-sec2-mobile">
                    
                    <p className="aboutme-detail">
                        This is <b>Mohamed Ayoub.</b><br></br> <br></br>
                        A 21 year old freelancer and tech enthusiast from Tunisia and currently residing in Hungary.
<br></br> <br></br>
My passion for creating software solutions started back in 2018. I have created different projects for different organizations and companies where I worked on developing mobile applications, websites and robotics projects.
<br></br><br></br>
